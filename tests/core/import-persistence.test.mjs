...
test('roster and schedule routes preserve a source before canonical writes and pass its artifact id', async () => {
  for (const path of ['../../app/api/roster/import/route.ts','../../app/api/schedule/import/route.ts']) {
